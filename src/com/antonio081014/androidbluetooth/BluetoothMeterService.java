...
public class BluetoothMeterService {
     ...
     */
    public BluetoothMeterService(Context context, Handler handler) {
	...
	public void run() {
		...
		try {
		    ...
		    mHandler.obtainMessage(Console.MESSAGE_READ, bytes, -1,
			    buffer).sendToTarget();
	...
	public void write(String buffer) {
		...
		mHandler.obtainMessage(Console.MESSAGE_WRITE, -1, -1, buffer)
			.sendToTarget();
	    } catch (IOException e) {
